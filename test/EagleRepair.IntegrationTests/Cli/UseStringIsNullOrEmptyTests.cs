...
namespace EagleRepair.IntegrationTests.Cli
{
    ...
    {
        [Theory]
        [MemberData(nameof(UseStringIsNullOrEmptySimpleDataProvider.TestCases), MemberType = typeof(UseStringIsNullOrEmptySimpleDataProvider))]
        ...
        [Theory]
        [MemberData(nameof(UseStringIsNullOrEmptyEdgeCasesDataProvider.TestCases), MemberType = typeof(UseStringIsNullOrEmptyEdgeCasesDataProvider))]
