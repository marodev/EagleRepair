...
namespace EagleRepair.IntegrationTests.Cli
{
    ...
    {
        [Theory]
        [MemberData(nameof(UsePatternMatchingDataProvider.TestCases), MemberType = typeof(UsePatternMatchingDataProvider))]
        ...
        [Theory]
        [MemberData(nameof(UsePatternMatchingNegativeDataProvider.TestCases), MemberType = typeof(UsePatternMatchingNegativeDataProvider))]
